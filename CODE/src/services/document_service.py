...
class DocumentService:
    ...
    def get_document(self, doc_id):
        ...
        if content:
            ...
            return DocumentModel(content, json.loads(metadata["metadata"]), doc_type)
        return None
    ...
    def search_documents(self, query, n_results=5):
        documents, metadatas, _ = self.db.search_documents(query, n_results)
        return [
            DocumentModel(doc, json.loads(meta["metadata"]), meta["doc_type"])
